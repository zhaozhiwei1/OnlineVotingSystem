...
@MultipartConfig
@WebServlet("/CreateMultipleOptionPoll")
public class CreateMultipleOptionPollServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            int maxChoices = Integer.parseInt(request.getParameter("maxChoices"));
            int minChoices = Integer.parseInt(request.getParameter("minChoices"));
