...
<div class="container">
  ...
  <form id="editMultiplePollForm" action="EditMultiplePoll" method="post">
    ...
    <div class="form-group">
      <label for="maxChoices">最大可选数量:</label>
      <input type="number" id="maxChoices" name="maxChoices" value="${poll.maxChoices}" min="2" required>
    </div>

    <div class="form-group">
      <label for="minChoices">最小可选数量:</label>
      <input type="number" id="minChoices" name="minChoices" value="${poll.minChoices}" min="1" required>
    </div>
